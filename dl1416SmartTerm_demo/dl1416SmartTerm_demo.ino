 ...
 *   2.1     12-07-2017    DJD         Special version for "Maker Made" show.  Add compiler
 *                                     directive, DEMO_MODE, to disable:
 *                                       Tiny Basic: HLIST, PLIST, SAVE, ERASE, INSRC, OUTDST
 *                                         AWRITE, DWRITE, MKDIR, RMDIR, DNDIR, UPDIR, AREAD,
 *                                         DREAD
 *                                       Terminal: Menu
 *                                     to enable:
